 ...
 * Handles OS verification tests with detailed test procedures and results
 */
class OSTestManager {
    constructor() {
    ...
    async writeParameter(slaveId, address, value) {
        ...
        return new Promise((resolve, reject) => {
            window.dashboard.modbusRTU.writeSingleRegister(slaveId, address, value, (error, response) => {
                if (error) {
