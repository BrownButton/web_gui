...
Maximum Coil Current [0xD13B]를 낮게 설정하여 토크 제한값을 낮추고, Closed-loop Velocity 모드로 구동 시 부하 증가에 의해 토크 제한에 도달하면 Warning Status [0xD012]의 Bit 6 (Torque Limit, 0x0040)이 Set되는지 확인한다.
