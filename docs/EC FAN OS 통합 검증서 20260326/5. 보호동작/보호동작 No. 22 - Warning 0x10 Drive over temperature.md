...
드라이브 제어부 온도가 Warning 임계값을 초과했을 때 Warning 신호가 발생하는지 확인하는 시험이다.

## 시험 목표

드라이브를 고부하로 운전하거나 제어부에 직접 열을 가하여 Electronics Temperature [0xD017]가 Warning 임계값을 초과하면, Warning Status [0xD012]의 Bit 4 (Drive Over Temperature, 0x0010)이 Set되는지 확인한다.
