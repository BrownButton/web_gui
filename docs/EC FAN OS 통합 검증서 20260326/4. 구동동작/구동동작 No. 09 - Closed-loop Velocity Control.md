...
Operating Mode [0xD106]을 Closed-loop Velocity(0x0000)로 설정하고 Set Point [0xD001]에 100rpm 속도 명령을 전송하여 Command Velocity [0xD051] 및 Actual Speed [0xD02D] 파라미터가 100rpm에 추종하는지 확인한다.
