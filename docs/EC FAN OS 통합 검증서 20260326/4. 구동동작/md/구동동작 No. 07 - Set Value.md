...
- Open-loop 모드에서 Set Point [0xD001]에 다양한 지령값(0%, 10%, 50%, 100%)을 입력하고 Command Torque [0xD050]가 기대값에 일치함을 확인한다.
- Closed-loop Velocity 모드에서 Set Point에 다양한 속도 지령값을 입력하고 Actual Speed [0xD02D]가 기대값에 추종함을 확인한다.
