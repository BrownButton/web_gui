...
Warning 0x08 IGBT Module over temperature

## 시험 목표

- 드라이브를 고부하로 운전하거나 열풍기로 IGBT 모듈 온도를 Warning 임계값 이상으로 상승시킨다.
- Warning Status [0xD012]의 Bit 3 (IGBT Module Over Temperature, 0x0008)이 Set됨을 확인한다.
