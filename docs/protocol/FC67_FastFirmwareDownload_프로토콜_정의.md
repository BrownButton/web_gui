# FC 0x67 : Fast Firmware Download 프로토콜
...
| FC 0x67 (19200, 60B, ACK only) | ~33 ms | ~1,900 | **~63 초** |
| FC 0x67 (19200, 120B, ACK only) | ~52 ms | ~950 | **~49 초** |
| FC 0x67 (19200, 240B, ACK only) | ~100 ms | ~475 | **~47 초** |
...
- [ ] **Baud Rate 변경 시퀀스 설계**
  ...
  - 폴링에 사용할 패킷 종류 결정 (FC 0x67 Init 재사용 vs 별도 ping)
