...
window.OSTestModules.push({
    ...
    tests: {
        ...
        'prot-0x10': {
            ...
            purpose: 'IPM(Intelligent Power Module) 단락 또는 하드웨어 이상 발생 시 ' +
                     '드라이브가 Error 0x10을 검출하고 출력을 차단하는지 확인한다.',
            model: 'EC-FAN',
            equipment: 'EC FAN 1EA, USB to RS485 Converter, 오실로스코프 (선택)',
            criteria: 'Error 0x10 발생 후 드라이브 출력 차단 확인, 알람 리셋 후 정상 복귀',
            steps: [
        ...
        'prot-0x11': {
            ...
            purpose: 'IPM 온도가 과온 임계값을 초과할 때 Error 0x11을 검출하는지 확인한다.',
            model: 'EC-FAN',
            equipment: 'EC FAN 1EA, USB to RS485 Converter, 열풍기 (IPM 가열용)',
            criteria: 'IPM 과온 시 Error 0x11 발생 및 출력 차단 확인',
            steps: [
                { type: 'check_connection', label: 'EC FAN 연결 상태 확인' },
                { type: 'check_comm_settings', label: 'Baudrate / Parity 설정 확인' },
                {
        ...
        'prot-0x14': {
            ...
            purpose: '모터 전류가 과전류 임계값을 초과할 때 Error 0x14를 검출하는지 확인한다.\n' +
                     '프로시저에 할당된 테스트 절차 또는 최대전류 파라미터를 낮춰 트리거한다.',
            model: 'EC-FAN',
            equipment: 'EC FAN 1EA, USB to RS485 Converter',
            criteria: 'Over current 조건 발생 시 Error 0x14 검출 및 출력 차단 확인',
            steps: [
                { type: 'check_connection', label: 'EC FAN 연결 상태 확인' },
                { type: 'check_comm_settings', label: 'Baudrate / Parity 설정 확인' },
                {
        ...
        'prot-0x15': {
            ...
            purpose: '전류 센서 오프셋 이상 발생 시 Error 0x15를 검출하는지 확인한다.\n' +
                     '프로시저에 할당된 테스트 절차로 트리거한다.',
            model: 'EC-FAN',
            equipment: 'EC FAN 1EA, USB to RS485 Converter',
            criteria: 'Current offset 이상 시 Error 0x15 검출 확인',
            steps: [
                { type: 'check_connection', label: 'EC FAN 연결 상태 확인' },
                { type: 'check_comm_settings', label: 'Baudrate / Parity 설정 확인' },
                {
        ...
        'prot-0x17': {
            ...
            purpose: 'IPM 온도가 저온 임계값 이하일 때 Error 0x17을 검출하는지 확인한다.\n' +
                     '⚠ 챔버 환경 미흡으로 현재 검증 실험 불가.',
            model: 'EC-FAN',
            equipment: 'EC FAN 1EA, USB to RS485 Converter, 환경 챔버 (저온)',
            criteria: '저온 챔버에서 Error 0x17 검출 확인 (챔버 환경 구축 후 진행)',
            steps: [
                { type: 'check_connection', label: 'EC FAN 연결 상태 확인' },
                { type: 'check_comm_settings', label: 'Baudrate / Parity 설정 확인' },
                {
        ...
        'prot-0x22': {
            ...
            purpose: '드라이브(제어부 또는 인버터) 온도가 Error 레벨 임계값 초과 시 ' +
                     'Error 0x22를 검출하는지 확인한다.',
            model: 'EC-FAN',
            equipment: 'EC FAN 1EA, USB to RS485 Converter, 열풍기',
            criteria: '드라이브 온도 과온 시 Error 0x22 발생 및 출력 차단 확인',
            steps: [
                { type: 'check_connection', label: 'EC FAN 연결 상태 확인' },
                { type: 'check_comm_settings', label: 'Baudrate / Parity 설정 확인' },
                {
        ...
        'prot-0x24': {
            ...
            purpose: '모터 케이블 개방(단선) 시 Error 0x24를 검출하는지 확인한다.',
            model: 'EC-FAN',
            equipment: 'EC FAN 1EA, USB to RS485 Converter',
            criteria: '모터 케이블 분리 후 드라이브 구동 시 Error 0x24 발생 확인',
            steps: [
                { type: 'check_connection', label: 'EC FAN 연결 상태 확인' },
                { type: 'check_comm_settings', label: 'Baudrate / Parity 설정 확인' },
                {
        ...
        'prot-0x25': {
            ...
            purpose: '드라이브 온도 Error 레벨 2 임계값 초과 시 Error 0x25를 검출하는지 확인한다.\n' +
                     '(0x22 vs 0x25: 인버터부/제어부 구분 — 사양서 확인 후 해당 센서 가열)',
            model: 'EC-FAN',
            equipment: 'EC FAN 1EA, USB to RS485 Converter, 열풍기',
            criteria: '드라이브 온도 레벨 2 초과 시 Error 0x25 발생 및 출력 차단 확인',
            steps: [
                { type: 'check_connection', label: 'EC FAN 연결 상태 확인' },
                { type: 'check_comm_settings', label: 'Baudrate / Parity 설정 확인' },
                {
        ...
        'prot-0x2a': {
            ...
            purpose: '모터 권선 불량 또는 회로 이상 발생 시 Error 0x2A를 검출하는지 확인한다.',
            model: 'EC-FAN',
            equipment: 'EC FAN 1EA, USB to RS485 Converter',
            criteria: '모터 회로 이상 조건 발생 시 Error 0x2A 검출 확인',
            steps: [
                { type: 'check_connection', label: 'EC FAN 연결 상태 확인' },
                { type: 'check_comm_settings', label: 'Baudrate / Parity 설정 확인' },
                {
        ...
        'prot-0x36': {
            ...
            purpose: '정현파 엔코더 신호 진폭이 하한 임계값 이하일 때 Error 0x36을 검출하는지 확인한다.',
            model: 'EC-FAN',
            equipment: 'EC FAN 1EA, USB to RS485 Converter, 가변 저항 또는 감쇠기',
            criteria: '엔코더 신호 진폭 저하 시 Error 0x36 검출 확인',
            steps: [
                { type: 'check_connection', label: 'EC FAN 연결 상태 확인' },
                { type: 'check_comm_settings', label: 'Baudrate / Parity 설정 확인' },
                {
        ...
        'prot-0x37': {
            ...
            purpose: '정현파 엔코더 신호 진폭이 상한 임계값 이상일 때 Error 0x37을 검출하는지 확인한다.\n' +
                     '⚠ 검증 실험 가능 여부 확인 후 불가 시 항목 삭제 예정.',
            model: 'EC-FAN',
            equipment: 'EC FAN 1EA, USB to RS485 Converter, 신호 증폭기 (선택)',
            criteria: '엔코더 신호 진폭 과다 시 Error 0x37 검출 확인 (검증 가능 시)',
            steps: [
                { type: 'check_connection', label: 'EC FAN 연결 상태 확인' },
                { type: 'check_comm_settings', label: 'Baudrate / Parity 설정 확인' },
                {
        ...
        'prot-0x40': {
            ...
            purpose: '입력 전압(DC Link)이 저전압 임계값 이하로 떨어질 때 Error 0x40을 검출하는지 확인한다.',
            model: 'EC-FAN',
            equipment: 'EC FAN 1EA, USB to RS485 Converter, 가변 AC/DC 전원공급기',
            criteria: 'DC Link 저전압 시 Error 0x40 발생 및 출력 차단 확인',
            steps: [
                { type: 'check_connection', label: 'EC FAN 연결 상태 확인' },
                { type: 'check_comm_settings', label: 'Baudrate / Parity 설정 확인' },
                {
        ...
        'prot-0x41': {
            ...
            purpose: '입력 전압(DC Link)이 과전압 임계값을 초과할 때 Error 0x41을 검출하는지 확인한다.',
            model: 'EC-FAN',
            equipment: 'EC FAN 1EA, USB to RS485 Converter, 가변 AC/DC 전원공급기',
            criteria: 'DC Link 과전압 시 Error 0x41 발생 및 출력 차단 확인',
            steps: [
                { type: 'check_connection', label: 'EC FAN 연결 상태 확인' },
                { type: 'check_comm_settings', label: 'Baudrate / Parity 설정 확인' },
                {
        ...
        'prot-0x42': {
            ...
            purpose: '제어부 RST(리셋) 전원 이상 발생 시 Error 0x42를 검출하는지 확인한다.',
            model: 'EC-FAN',
            equipment: 'EC FAN 1EA, USB to RS485 Converter',
            criteria: 'RST 전원 이상 시 Error 0x42 발생 확인',
            steps: [
                { type: 'check_connection', label: 'EC FAN 연결 상태 확인' },
                { type: 'check_comm_settings', label: 'Baudrate / Parity 설정 확인' },
                {
        ...
        'prot-0x50': {
            ...
            purpose: '모터 속도가 최대 속도 제한을 초과할 때 Error 0x50을 검출하는지 확인한다.',
            model: 'EC-FAN',
            equipment: 'EC FAN 1EA, USB to RS485 Converter',
            criteria: '속도 제한 초과 시 Error 0x50 발생 및 출력 차단 확인',
            steps: [
                { type: 'check_connection', label: 'EC FAN 연결 상태 확인' },
                { type: 'check_comm_settings', label: 'Baudrate / Parity 설정 확인' },
                {
        ...
        'prot-0x53': {
            ...
            purpose: '목표 속도 대비 실제 속도의 편차가 허용 범위를 초과할 때 Error 0x53을 검출하는지 확인한다.',
            model: 'EC-FAN',
            equipment: 'EC FAN 1EA, USB to RS485 Converter, 부하 장치 (샤프트 잠금 또는 부하기)',
            criteria: '속도 편차 과다 시 Error 0x53 발생 확인',
            steps: [
                { type: 'check_connection', label: 'EC FAN 연결 상태 확인' },
                { type: 'check_comm_settings', label: 'Baudrate / Parity 설정 확인' },
                {
        ...
        'prot-0x58': {
            ...
            purpose: '모터 샤프트가 물리적으로 잠겨 회전하지 못할 때 Error 0x58을 검출하는지 확인한다.',
            model: 'EC-FAN',
            equipment: 'EC FAN 1EA, USB to RS485 Converter, 샤프트 잠금 장치',
            criteria: '샤프트 고착 상태에서 구동 명령 시 Error 0x58 발생 확인',
            steps: [
                { type: 'check_connection', label: 'EC FAN 연결 상태 확인' },
                { type: 'check_comm_settings', label: 'Baudrate / Parity 설정 확인' },
                {
        ...
        'prot-w01': {
            ...
            purpose: 'DC Link 전압이 경고 레벨 저전압 임계값 이하일 때 Warning 0x01을 발생시키는지 확인한다.\n' +
                     '(Error 0x40과 달리 출력은 계속되나 경고 플래그 set)',
            model: 'EC-FAN',
            equipment: 'EC FAN 1EA, USB to RS485 Converter, 가변 AC/DC 전원공급기',
            criteria: 'DC Link 저전압 경고 레벨 진입 시 Warning 0x01 플래그 확인',
            steps: [
                { type: 'check_connection', label: 'EC FAN 연결 상태 확인' },
                { type: 'check_comm_settings', label: 'Baudrate / Parity 설정 확인' },
                {
        ...
        'prot-w02': {
            ...
            purpose: 'DC Link 전압이 경고 레벨 과전압 임계값을 초과할 때 Warning 0x02를 발생시키는지 확인한다.',
            model: 'EC-FAN',
            equipment: 'EC FAN 1EA, USB to RS485 Converter, 가변 AC/DC 전원공급기',
            criteria: 'DC Link 과전압 경고 레벨 진입 시 Warning 0x02 플래그 확인',
            steps: [
                { type: 'check_connection', label: 'EC FAN 연결 상태 확인' },
                { type: 'check_comm_settings', label: 'Baudrate / Parity 설정 확인' },
                {
        ...
        'prot-w04': {
            ...
            purpose: '모터 온도가 경고 레벨 임계값을 초과할 때 Warning 0x04를 발생시키는지 확인한다.',
            model: 'EC-FAN',
            equipment: 'EC FAN 1EA, USB to RS485 Converter, 열풍기 (모터 가열용)',
            criteria: '모터 과온 경고 레벨 진입 시 Warning 0x04 플래그 확인',
            steps: [
                { type: 'check_connection', label: 'EC FAN 연결 상태 확인' },
                { type: 'check_comm_settings', label: 'Baudrate / Parity 설정 확인' },
                {
        ...
        'prot-w08': {
            ...
            purpose: 'IGBT 모듈 온도가 경고 레벨 임계값을 초과할 때 Warning 0x08을 발생시키는지 확인한다.',
            model: 'EC-FAN',
            equipment: 'EC FAN 1EA, USB to RS485 Converter, 열풍기',
            criteria: 'IGBT 과온 경고 레벨 진입 시 Warning 0x08 플래그 확인',
            steps: [
                { type: 'check_connection', label: 'EC FAN 연결 상태 확인' },
                { type: 'check_comm_settings', label: 'Baudrate / Parity 설정 확인' },
                {
        ...
        'prot-w10': {
            ...
            purpose: '드라이브 제어부 온도가 경고 레벨 임계값을 초과할 때 Warning 0x10을 발생시키는지 확인한다.',
            model: 'EC-FAN',
            equipment: 'EC FAN 1EA, USB to RS485 Converter, 열풍기',
            criteria: '제어부 과온 경고 레벨 진입 시 Warning 0x10 플래그 확인',
            steps: [
                { type: 'check_connection', label: 'EC FAN 연결 상태 확인' },
                { type: 'check_comm_settings', label: 'Baudrate / Parity 설정 확인' },
                {
        ...
        'prot-w40': {
            ...
            purpose: '모터 출력 토크가 제한값에 도달할 때 Warning 0x40 플래그를 발생시키는지 확인한다.',
            model: 'EC-FAN',
            equipment: 'EC FAN 1EA, USB to RS485 Converter, 부하 장치',
            criteria: '토크 제한 도달 시 Warning 0x40 플래그 확인 (속도/출력 제한 동작 포함)',
            steps: [
                { type: 'check_connection', label: 'EC FAN 연결 상태 확인' },
                { type: 'check_comm_settings', label: 'Baudrate / Parity 설정 확인' },
                {
